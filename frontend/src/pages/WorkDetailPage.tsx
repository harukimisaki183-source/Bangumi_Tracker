        ...
        <div className="max-w-4xl mx-auto px-4 py-10 relative z-10">
          ...
          <motion.div className="flex flex-col md:flex-row gap-8"
            ...
            <motion.div className="w-full md:w-56 flex-shrink-0"
              whileHover={isScrapbook ? { scale: 1.02 } : { scale: 1.02, rotate: -1 }}
              transition={{ type: "spring", stiffness: 300, damping: 20 }}>
              <div
                className={isScrapbook ? "scrapbook-photo" : ""}
                style={{
                  borderRadius: isScrapbook ? "2px" : "var(--radius-card)",
            ...
            <div className="flex-1 space-y-4">
              <div className="flex flex-wrap items-center gap-2">
                {isScrapbook ? (
                  <span className={`scrapbook-sticker scrapbook-sticker-${work.type}`}>
          ...
          >
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="heading-section text-base" style={{ color: "var(--text-primary)" }}>
                    删除作品
                  </h3>
                  <p className="text-[0.8rem] mt-0.5" style={{ color: "var(--text-tertiary)" }}>
                    此操作不可撤销
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-3 justify-end">
                <motion.button onClick={() => setShowDeleteConfirm(false)} disabled={deleting}
                  className="btn-ghost text-sm disabled:opacity-50" whileTap={{ scale: 0.97 }}>
                  取消
                </motion.button>
